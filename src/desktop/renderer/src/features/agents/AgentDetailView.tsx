...
export function AgentDetailView({
	...
	const [channelDraft, setChannelDraft] = useState<AgentDraft>({
		...
		dingtalkClientId: agent.dingtalk?.clientId ?? "",
		dingtalkClientSecret: agent.dingtalk?.clientSecret ?? "",
	...
	const savedChannelDraft = useMemo(() => ({
		...
		agent.dingtalk?.clientId,
		agent.dingtalk?.clientSecret,
	...
	const nextChannelDraft = useMemo(() => ({
		...
		dingtalkClientId: channelDraft.dingtalkClientId,
		dingtalkClientSecret: channelDraft.dingtalkClientSecret,
