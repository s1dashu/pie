...
4. DingTalk 已接入桌面创建入口和 runtime，当前支持应用机器人 Stream 模式文本回复。
5. Slack 和 Telegram 仍是隐藏的开发中渠道。
...
最新已打 tag 的 pre-release 构建是 [Pie 0.2.2](https://github.com/s1dashu/pie/releases/tag/v0.2.2)。当前源码版本是 0.2.4。
...
4. **Channels**：接收消息、发送回复，并为 Feishu/Lark、WeChat、Discord、DingTalk 和未来 adapter 翻译 IM 事件。
